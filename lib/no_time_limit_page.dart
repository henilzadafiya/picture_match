...
import 'package:picture_match/data_class.dart';
import 'package:picture_match/game_paly.dart';
import 'package:picture_match/home.dart';
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
                image: AssetImage("assets/background/fondo_imagenes.png"),
                fit: BoxFit.fill)),
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return Card(
                            child: ListTile(
                              tileColor: ((myindex * 10) + index + 1 <=
                                      leval_number + 1)
                                  ? Colors.teal
                                  : Colors.teal.shade300,
                              onTap: () {
                                if ((myindex * 10) + index + 1 <=
                                    leval_number + 1) {
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) {
                                        return game_play(myindex * 10 + index);
                                      },
                                    ),
                                  );
                                }
